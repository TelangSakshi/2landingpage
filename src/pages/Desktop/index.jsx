            ...
            <div>
              <div className="relative h-[753px] self-end">
                ...
                <Img
                  ...
                  alt="messageone_one"
                  className="absolute right-[10%] top-[12%] m-auto h-[200px] w-[200px] object-cover"
                />
              </div>
            </div>
          </div>
            ...
            <div className="mb-[23px] flex w-[88%] flex-col items-center gap-9 md:w-full">
              ...
              <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
                <Img
                  ...
                  alt="acmeone_one"
                  className="h-[32px] w-[14%] object-cover md:w-full h-full"
                />
                <Img
                  src="images/img_quantum_1.png"
                  alt="quantumone_one"
                  className="h-[32px] w-[12%] object-cover md:w-full h-full"
                />
                <Img
                  src="images/img_echo_1.png"
                  alt="echoone_one"
                  className="h-[25px] w-[15%] object-cover md:w-full h-full"
                />
                <Img
                  src="images/img_celestia_1.png"
                  alt="celestiaone_one"
                  className="h-[26px] w-[11%] object-cover md:w-full h-full"
                />
                <Img
                  src="images/img_pulse_1.png"
                  alt="pulseone_one"
                  className="h-[20px] w-[10%] object-cover md:w-full h-full"
                />
                <Img src="images/img_apex_1.png" 
                alt="apexone_one" className="h-[26px] w-[7%] object-cover md:w-full h-full" />
              </div>
            </div>
          </div>
